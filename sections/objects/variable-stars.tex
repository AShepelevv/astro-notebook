...
\begin{wrapfigure}[11]{r}{0.47\tw}
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Кривая блеска переменной типа RR~Lyr} % NGC 5024 (M53) V1 (V) https://vizier.cds.unistra.fr/viz-bin/VizieR-3?-source=J/MNRAS/420/1333/table1&-out.max=1000&-out.form=HTML%20Table&-oc.form=sexa
